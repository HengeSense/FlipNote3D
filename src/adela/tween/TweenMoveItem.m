...
-(void)update:(float)time{
    ...
    if (_delayRemainTime==0 && elapsedTime>_delayTime) {
        ...
        _target.x       = _easeFunc(elapsedTime,_startX,_changeX,_durationTime);
        _target.y       = _easeFunc(elapsedTime,_startY,_changeY,_durationTime);
        _target.z       = _easeFunc(elapsedTime,_startZ,_changeZ,_durationTime);
    }
}
@end
